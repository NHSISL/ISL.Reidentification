...
namespace ISL.ReIdentification.Core.Tests.Unit.Services.Foundations.DelegatedAccesses
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionOnRemoveByIdWhenDelegatedAccessIdIsInvalidAndLogItAsync()
        {
            // given
            ...
            ValueTask<DelegatedAccess> removeDelegatedAccessByIdTask =
                this.delegatedAccessService.RemoveDelegatedAccessByIdAsync(invalidDelegatedAccessId);
