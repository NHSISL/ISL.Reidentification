...
namespace ISL.ReIdentification.Core.Tests.Unit.Services.Foundations.ImpersonationContexts
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionOnRetrieveByIdWhenImpersonationContextIdIsInvalidAndLogItAsync()
        {
            // given
            ...
            ValueTask<ImpersonationContext> retrieveImpersonationContextByIdTask =
                this.impersonationContextService.RetrieveImpersonationContextByIdAsync(invalidImpersonationContextId);
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnRetrieveByIdIfImpersonationContextIdNotFoundAndLogitAsync()
        {
            //given
